...
if [ $1 == stable ]; then # This has been merged into mainline since v6.2
	...
	patch -Np1 < ../patches/0001-mm-Support-soft-dirty-flag-reset-for-VA-range.patch
	patch -Np1 < ../patches/0001-add-sysctl-to-disallow-unprivileged-CLONE_NEWUSER-by.patch
	...
	patch -Np1 < ../patches/0008-6.1-bcachefs.patch
	patch -Np1 < ../patches/0009-glitched-bmq.patch
	patch -Np1 < ../patches/0009-glitched-ondemand-bmq.patch
